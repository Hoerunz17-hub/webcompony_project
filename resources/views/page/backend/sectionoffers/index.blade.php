                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title border-bottom pb-2 mb-2">
                                    <h4 class="mb-0">Section Offers</h4>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="javascript:void(0)">Section Offers</a>
                                    </li>
                ...
                <div class="col-sm-12">
                    <div class="card table-card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="/admin/discont/create" class="btn fw-bold text-white"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($disconts as $discont)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    @if ($discont->photo)
                                                        <img src="{{ asset('storage/' . $discont->photo) }}"
                                                            alt="Hero Image"
                                                ...
                                                <td>{{ $discont->title }}</td>
                                                <td>{{ $discont->description }}</td>
                                                <td>
                                                    <div class="form-check form-switch d-flex justify-content-center">
                                                        <input class="form-check-input custom-switch-lg toggle-status"
                                                            type="checkbox" role="switch" data-id="{{ $discont->id }}"
                                                            {{ $discont->is_active === 'active' ? 'checked' : '' }}>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="/admin/discont/edit/{{ $discont->id }}"
                                                    ...
                                                    <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"
                                                        href="/admin/discont/delete/{{ $discont->id }}"
