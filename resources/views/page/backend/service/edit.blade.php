            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin/service/update/{{ $service->id }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf

                                <div class="mb-3">
                                    <label for="foto" class="form-label">UbahFoto</label>
                                    <input type="file" class="form-control" name="foto" id="foto">

                                    @if ($service->photo)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $service->photo) }}" alt="Foto Lama"
